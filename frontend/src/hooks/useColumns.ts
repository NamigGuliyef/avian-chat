...
const defaultColumns: ColumnConfig[] = [
  ...
  },
  {
    ...
    type: 'select',
    options: [
      { value: 'successful', label: 'Uğurlu', color: 'green' },
      { value: 'unsuccessful', label: 'Uğursuz', color: 'red' },
      { value: 'callback', label: 'Geri zəng', color: 'orange' },
      { value: 'pending', label: 'Gözləyir', color: 'yellow' },
      { value: 'no_answer', label: 'Cavab yoxdur', color: 'gray' },
    ],
    visibleToUser: true,
    editableByUser: true,
    order: 2,
  ...
  },
  {
    ...
    options: [
      ...
      { value: 'not_ok', label: 'Not Ok', color: 'red' },
      { value: 'interested', label: 'Maraqlıdır', color: 'orange' },
      { value: 'pending', label: 'Gözləyir', color: 'orange' },
    ],
    visibleToUser: true,
    editableByUser: true,
    order: 4,
